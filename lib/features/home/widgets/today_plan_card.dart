...
import 'package:my_plan/features/home/widgets/meal_actions_sheet.dart';
  ...
  Widget build(BuildContext context) {
    final (background, label, foreground, sheetStatus) = switch (status) {
      _MealStatus.logged => (
        ...
        'Logged',
        AppColors.green,
        MealActionStatus.logged,
      ),
      _MealStatus.planned => (
        Color(0xFFF0EFFF),
        'Planned',
        Color(0xFF5B5AE8),
        MealActionStatus.planned,
      ),
      _MealStatus.skipped => (
        AppColors.redTrack,
        'Skipped',
        AppColors.red,
        MealActionStatus.skipped,
      ),
    };
    return InkWell(
      onTap: () => Navigator.of(context).push(
        ...
        child: Row(
          children: [
              ...
              child: Column(
                ...
                children: [
                  ...
                  Align(
                    ...
                    child: SmallStatus(
                      text: translateText(context, label),
            ...
            IconButton(
              ...
              onPressed: () => MealActionsSheet.show(
                context: context,
                mealName: translateText(context, title),
                mealTime: time,
                nutrition: nutrition,
                status: sheetStatus,
              ),
